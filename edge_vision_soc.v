...
`endif
  ...
  wire [7:0] sobel_thresh_var;
  wire [1:0] hw_accel_mode;
  wire       dma_wr_init_done;
...
`endif
  ...
  hw_accel_apb3 #(
      ...
      .sobel_thresh_var (sobel_thresh_var),
      .hw_accel_mode    (hw_accel_mode),
      .dma_wr_init_done (dma_wr_init_done)
  );
